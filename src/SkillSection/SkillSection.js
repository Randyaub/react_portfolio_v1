...
const SkillSection = () => {
  return (
    <section className="c-SkillSection">
      <div className="container">
        <div className="c-SkillSection__title">
          <h3>Technical Skills</h3>
        </div>
        <div className="c-SkillSection__skills">
          <div className="c-SkillSection__item">
            {/*HTML5 ICON*/}
            <svg className="c-SkillSection__image" viewBox="0 0 128 128">
              <path
                fill="#E44D26"
